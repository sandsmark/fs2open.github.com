...
static SCP_string opengl_shader_get_header(shader_type type_id, int flags, bool has_geo_shader) {
	...
	if (type_id == SDR_TYPE_POST_PROCESS_MAIN || type_id == SDR_TYPE_POST_PROCESS_LIGHTSHAFTS || type_id == SDR_TYPE_POST_PROCESS_FXAA || type_id == SDR_TYPE_POST_PROCESS_SMAA_EDGE || type_id == SDR_TYPE_POST_PROCESS_SMAA_BLENDING_WEIGHT || type_id == SDR_TYPE_POST_PROCESS_SMAA_NEIGHBORHOOD_BLENDING) {
